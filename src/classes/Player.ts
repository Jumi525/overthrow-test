...
//       this.setRotation(Math.atan2(this.moveDir.y, this.moveDir.x));
//     }
//   }
...
//       // Fire projectile or perform melee swing
...
//     this.currency += 5 * this.getComboMultiplier();
